...
public class WebStatisticController {
    ...
    private String getUserName(UUID userId) {
        UserRepresentation user = keycloakUserService.getUserRepresentation(userId);
        if (user != null) {
            String fn = user.getFirstName() == null ? (user.getUsername() == null ? "" : user.getUsername())  : user.getFirstName();
